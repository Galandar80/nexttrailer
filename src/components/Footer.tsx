          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 text-sm">
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li><Link to="/catalogo" className="hover:text-accent">Catalogo</Link></li>
                <li><Link to="/news" className="hover:text-accent">News</Link></li>
                <li><Link to="/oscar" className="hover:text-accent">Oscar</Link></li>
                <li><Link to="/genres" className="hover:text-accent">Sfoglia</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li><Link to="/storico" className="hover:text-accent">Storico</Link></li>
                <li><Link to="/search" className="hover:text-accent">Cerca</Link></li>
                <li><Link to="/notifiche" className="hover:text-accent">Notifiche</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li><Link to="/profilo" className="hover:text-accent">Profilo</Link></li>
                <li><Link to="/preferenze" className="hover:text-accent">Preferenze</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li><Link to="/catalogo" className="hover:text-accent">Film e Serie</Link></li>
                <li><Link to="/news" className="hover:text-accent">Ultime news</Link></li>
                <li><Link to="/search" className="hover:text-accent">Ricerca titoli</Link></li>
              </ul>
            </div>
          </div>
        </div>
