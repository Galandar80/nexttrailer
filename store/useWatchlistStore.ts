    ...
    persist(
        ...
        },
        {
            ...
            storage: createJSONStorage(() => ({
                getItem: () => localStorage.getItem(getUserStorageKey()),
                setItem: (...args: [string, string]) => localStorage.setItem(getUserStorageKey(), args[1]),
                removeItem: () => localStorage.removeItem(getUserStorageKey())
            }))
        }
    )
);
