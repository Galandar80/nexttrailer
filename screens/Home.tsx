        ...
        <main className="flex flex-col gap-16">
              ...
              <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
                <div className="space-y-6">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <Button onClick={() => router.push("/storico")} className="bg-accent hover:bg-accent/90">
          ...
          <section className="max-w-screen-2xl mx-auto px-4 md:px-8 grid gap-8 lg:grid-cols-[1fr_1fr] items-start">
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                <Button variant="default" onClick={() => router.push("/search")}>
                  Inizia a cercare
                </Button>
            ...
            <div className="rounded-3xl border border-muted/30 bg-secondary/30 p-8 md:p-12">
              <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <Button className="bg-accent hover:bg-accent/90" onClick={() => router.push("/storico")}>
                      Registrati gratis
                    </Button>
